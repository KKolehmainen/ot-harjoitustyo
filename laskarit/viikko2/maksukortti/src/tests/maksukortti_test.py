...
class TestMaksukortti(unittest.TestCase):
	...
	def test_kortilla_pystyy_ostamaan_edullisen_lounaan_kun_kortilla_on_rahaa_vain_edullisen_lounaan_verran(self):
	...
	def test_kortilla_pystyy_ostamaan_maukkaan_lounaan_kun_kortilla_on_rahaa_vain_maukkaan_lounaan_verran(self):
